...
import ActionsIcon from "!svg-react-loader!../../images/svg-icons/actions-icon-actions.svg?name=ActionsIcon";
...
const StackIcons = props => {
  ...
  const items = [
    ...
    { name: "actions", url: "https://github.co.jp/features/actions", comp: ActionsIcon },
